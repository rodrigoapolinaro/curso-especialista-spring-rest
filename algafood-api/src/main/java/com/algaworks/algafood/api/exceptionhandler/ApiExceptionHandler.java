...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleValidationInternal(Exception ex, BindingResult bindingResult, HttpHeaders headers, 
	...
	private ResponseEntity<Object> handleMethodArgumentTypeMismatch(
		...
		String detail = String.format("O parâmetro de URL '%s' recebeu o valor '%s', que é de um tipo inválido. "
				+ "Corrija e informe um valor compatível com o %s.",
	...
	private ResponseEntity<Object> handlePropertyBinding(PropertyBindingException ex,
		...
		// Criei o método joinPath para reaproveitar em todos os métods que precisam
	...
	public ResponseEntity<?> handleEntidadeNaoEncontrada(EntidadeNaoEncontraException ex, 
				WebRequest request) {
