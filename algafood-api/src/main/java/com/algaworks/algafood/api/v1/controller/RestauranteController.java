...
import com.algaworks.algafood.domain.exception.RestauranteNaoEncontraException;
...
//	@JsonView(RestauranteView.ApenasNome.class)
	...
	public RestauranteModel adicionar(@RequestBody @Valid RestauranteInput restauranteInput) {	
		...
		} catch(CozinhaNaoEncontraException | CidadeNaoEncontraException e) {
	...
	@ResponseStatus(HttpStatus.NO_CONTENT)
	public ResponseEntity<Void> ativar(@RequestBody List<Long> restauranteIds) {
		try {
			cadastroRestaurante.ativar(restauranteIds);
			
			return ResponseEntity.noContent().build();
		} catch (RestauranteNaoEncontraException e) {
	...
	@ResponseStatus(HttpStatus.NO_CONTENT)
	public ResponseEntity<Void> inativar(@RequestBody List<Long> restauranteIds) {
		try {
